...
| --- | --- |
| [demo-number-plates](https://github.com/m-spangenberg/demo-number-plates) | A system design repo demonstrating a solution to the problem of efficiently searching for the availability of standard and vanity number plates in Namibia. |
| [demo-php-kafka](https://github.com/m-spangenberg/demo-php-kafka) | A fleet tracker dashboard for the ingest and management of vehicle data using PHP and Kafka. |
| [demo-py-frauddetection](https://github.com/m-spangenberg/demo-py-frauddetection) | A synthetic-data demo that explores referral bonus abuse, which is a common fraud scenario in fintech and e-commerce. |
